...
- **Star**: 308 · **Fork**: 20 · **开放 issue**: 12 · **贡献者**: 3

## 累计统计

- **发布数**: 10 · **已合并 PR**: 20 · **开放 PR**: 0 · **已关闭 issue**: 8 · **开放 issue**: 4 · **提交数**: 154
...
| last180d | 2026-03-17 | 1 | 2 | 0 | 1 | 0 | 1 |
| 360d | 2025-09-18 | 8 | 11 | 0 | 3 | 3 | 69 |
| last720d | 2024-09-23 | 10 | 20 | 0 | 8 | 4 | 154 |
...
在 [repology.org](https://repology.org/project/domain-check) 上共有 **8** 个发行版报告此项目。**2** 个 ✅ 已是最新上游版本，**0** 个 ⚠️ 使用旧版本。

| 发行版 | 版本 | 状态 |
|--------|------|------|
| Homebrew | `1.0.2` | ✅ latest |
| Nix unstable | `1.0.2` | ✅ latest |
...
_数据快照: `data/card/260913.yml` · 2026-09-13T02:06:11Z._
