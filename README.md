...
- **Upstream**: <https://github.com/saidutt46/domain-check>
- **Homepage**: <https://crates.io/crates/domain-check>
- **License**: NOASSERTION
...
- **Stars**: 308 · **Forks**: 20 · **Open issues**: 12 · **Contributors**: 3

## Totals (cumulative)

- **Releases**: 10 · **Merged PRs**: 20 · **Open PRs**: 0 · **Closed issues**: 8 · **Open issues**: 4 · **Commits**: 154
...
Reported by **8** distros on [repology.org](https://repology.org/project/domain-check). **2** are ✅ on the latest upstream release, **0** are ⚠️ on an older version.
...
_Snapshot: `data/card/260913.yml` · 2026-09-13T02:06:11Z._
